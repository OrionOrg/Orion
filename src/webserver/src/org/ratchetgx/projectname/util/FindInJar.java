package org.ratchetgx.projectname.util;
...
public class FindInJar {
    ...
    public static void main(String args[]) {
        FindInJar findInJar = new FindInJar("org.apache.tools.zip.ZipOutputStream");
        List jarFiles = findInJar.findClass("D:/IBM/WebSphere6.1/AppServer/profiles/AppSrv03/installedApps/anthony-wisNode14Cell/ssfw_war.ear/base-src/web/WEB-INF/lib/", true);
        if (jarFiles.size() == 0) {
