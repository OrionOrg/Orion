...
$(document).ready(function() {
	...
	//正确格式如(英文半角)：09:30 或 14:30
    jQuery.validator.addMethod("isTimeStr", function(value, element,param) {
         var tel =  /^(0\d{1}|1\d{1}|2[0-3]):([0-5]\d{1})$/;
        return this.optional(element) || (tel.test(value));
    }, "<font color=red>&nbsp;时间格式不正确！正确格式如(英文半角)：09:30 或 14:30&nbsp;</font> ");
